...
export const ShowProductsContext = createContext<React.Dispatch<
...
function HomePage() {
  ...
  return (
    <>
      <ShowProductsContext.Provider value={setShowProducts}>
        ...
        <div className="absolute bottom-0.5 left-1/2 size-11 -translate-x-1/2 cursor-pointer rounded-t-full border-8 border-neutral-950 bg-neutral-950 select-none sm:size-12">
          <img src={Indo} alt="" className="h-full rounded-full" />
          <img src={UK} alt="" className="hidden h-full rounded-full" />
        </div>
      </ShowProductsContext.Provider>
    </>
  );
}
