import CBXHNW06 from "/CBXHNW/WP_TEXTURE-CBXHNW06_0.jpg";
import CBXHNW08 from "/CBXHNW/WP_TEXTURE-CBXHNW08_0.jpg";
import CBXHNW09 from "/CBXHNW/WP_TEXTURE-CBXHNW09_0.jpg";
...
function CBXHNW() {
  ...
  const ProductsSizeArray = [CBXHNW06_Size, CBXHNW08_Size, CBXHNW09_Size];

  const ProductsLabel = ["CBXHNW06", "CBXHNW08", "CBXHNW09"];
  ...
  return (
    <>
      ...
      <div className="pointer-events-none absolute bottom-15 flex text-4xl font-extrabold text-neutral-600 mix-blend-difference">
        Papan Wall Panel (Texture) Charcoal
      </div>
      {zoomProducts !== null && (
